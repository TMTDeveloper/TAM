...
using TamRiskProject.ViewModels;
using TamRiskProject.Helpers;
using TamRiskProject.Authorization;
...
namespace TamRiskProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("TamRiskProject"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "TamRiskProject API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "TamRiskProject API V1");
            });
